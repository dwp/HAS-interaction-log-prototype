...
// branching for assessment screen outgoing contact
...
router.post('/version-1-0-0/log-condensed', function (req, res) {
  // Get the answer from session data
  // The name between the quotes is the same as the 'name' attribute on the input elements
  // However in JavaScript we can't use hyphens in variable names
  ...
  if (what == 'outgoing') {
    res.redirect('/version-1-0-0/outgoing')
  }
  else if (what == 'incoming') {
    res.redirect('/version-1-0-0/incoming')
  }
  else {
    res.redirect('/version-1-0-0/event')
  }
})

router.post('/version-1-0-0/user-contact', function (req, res) {
  // Get the answer from session data
  // The name between the quotes is the same as the 'name' attribute on the input elements
  // However in JavaScript we can't use hyphens in variable names
  ...
  if (usercontact == 'yes') {
    ...
    res.redirect('/version-1-0-0/index')
  }
})

router.post('/version-1-0-1/log-condensed', function (req, res) {
  // Get the answer from session data
  // The name between the quotes is the same as the 'name' attribute on the input elements
  // However in JavaScript we can't use hyphens in variable names
  ...
  if (what == 'outgoing') {
    res.redirect('/version-1-0-1/outgoing')
  }
  else if (what == 'incoming') {
    res.redirect('/version-1-0-1/incoming')
  }
  else {
    res.redirect('/version-1-0-1/event')
  }
})

router.post('/version-1-0-1/user-contact', function (req, res) {
  // Get the answer from session data
  // The name between the quotes is the same as the 'name' attribute on the input elements
  // However in JavaScript we can't use hyphens in variable names
  ...
  if (usercontact == 'yes') {
    ...
    res.redirect('/version-1-0-1/index')
  }
})
